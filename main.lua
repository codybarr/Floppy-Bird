...
local ground = love.graphics.newImage('assets/images/ground2.png')
...
local BACKGROUND_LOOPING_POINT = 816
...
function love.load()
	...
	sounds = {
		...
		-- https://freesound.org/people/Setuniman/sounds/171394/
		['music'] = love.audio.newSource('assets/sounds/cozy.mp3', 'static')
	}
